...
```text
  ...
  -h, --help                        help for apply
      ...
      --size string                 cluster size: small, medium, or large — determines the default addon set. Argo CD and cluster-autoscaler ship at every size; medium adds Velero+Falco, large adds strict Kyverno policies + audit logging + OTel (default "small")
