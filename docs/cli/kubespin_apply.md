...
```text
  ...
  -h, --help                        help for apply
      ...
      --size string                 cluster size: small, medium, or large — determines the default addon set. Argo CD and cluster-autoscaler ship at every size; medium adds Velero+Falco, large raises Pod Security policies to restricted (audit mode) and adds an OTel collector (default "small")
