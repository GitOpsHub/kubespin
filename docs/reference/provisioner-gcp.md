...
<details>
<summary>`type Clients struct { ... }`</summary>
...
<details>
<summary>type Option func(*Clients)</summary>
...
<details>
<summary>func NewClients(ctx context.Context, project string, opts ...Option) (*Clients, error)</summary>
...
<details>
<summary>`type names struct { ... }` (internal)</summary>
...
<details>
<summary>Internal client-facade interfaces</summary>
...
<details>
<summary>`type ClusterProvisioner struct { ... }`</summary>
...
<details>
<summary>func NewClusterProvisioner(c *Clients) *ClusterProvisioner</summary>
...
<details>
<summary>func (p *ClusterProvisioner) Provider() core.Provider</summary>
...
<details>
<summary>func (p *ClusterProvisioner) Create(ctx context.Context, spec core.ClusterSpec) error</summary>
...
<details>
<summary>func (p *ClusterProvisioner) Describe(ctx context.Context, spec core.ClusterSpec) (provisioner.ClusterState, error)</summary>
...
<details>
<summary>func (p *ClusterProvisioner) Reconcile(ctx context.Context, spec core.ClusterSpec) (provisioner.Change, error)</summary>
...
<details>
<summary>func (p *ClusterProvisioner) Delete(ctx context.Context, spec core.ClusterSpec) error</summary>
...
<details>
<summary>`type NetworkProvisioner struct { ... }`</summary>
...
<details>
<summary>func NewNetworkProvisioner(c *Clients) *NetworkProvisioner</summary>
...
<details>
<summary>func (p *NetworkProvisioner) Provider() core.Provider</summary>
...
<details>
<summary>func (p *NetworkProvisioner) EnsureNetwork(...) (provisioner.NetworkResult, error)</summary>
...
<details>
<summary>func (p *ClusterProvisioner) RESTConfig(ctx context.Context, spec core.ClusterSpec) (*rest.Config, error)</summary>
