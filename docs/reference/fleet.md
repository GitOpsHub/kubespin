...
<details>
<summary>`Option` / `options` — configures a fleet-wide operation</summary>
...
<details>
<summary>`ClusterProvisionerFactory` — builds a provisioner per cluster</summary>
...
<details>
<summary>`AuditResult` — one cluster's audit outcome</summary>
...
<details>
<summary>`Audit` — fans out `AuditOne` across all matching clusters</summary>
...
<details>
<summary>`Finding` — one drift against `cluster.yaml`</summary>
...
<details>
<summary>`AuditOne` — diffs live state against desired `cluster.yaml`</summary>
...
<details>
<summary>`desiredSpec` (unexported, shared with `update.go`) — parses `cluster.yaml`</summary>
...
<details>
<summary>`ClusterStatus` — one row in `fleet status`</summary>
...
<details>
<summary>`Status` — builds status rows from registry data alone</summary>
...
<details>
<summary>`UpdateResult` — one cluster's outcome from an update wave</summary>
...
<details>
<summary>`UpdateOne` — pins a version and commits for one cluster</summary>
...
- **Params**: `resolver` — resolves `spec.Size` to a `catalog.Profile`; `repoProv` — repository access for committing `addons.yaml`; `spec` — the cluster's spec, including its existing `Overrides`; `component`, `version` — the addon and version to pin.
...
<details>
<summary>`setComponentVersion` (unexported) — pins a component's version</summary>
...
<details>
<summary>`Update` — rolls a version out fleet-wide, canary wave first</summary>
...
<details>
<summary>`countFailedUpdates` (unexported) — counts errored results</summary>
...
<details>
<summary>`updateWave` (unexported) — runs `updateRecord` across a wave</summary>
...
<details>
<summary>`updateRecord` (unexported) — updates one cluster's addon override</summary>
...
<details>
<summary>`DashboardRow` — one row in `fleet dashboard`</summary>
...
<details>
<summary>`Dashboard` — builds dashboard rows from registry data alone</summary>
